...
const PendingStatus: React.FC = () => {
    ...
    return (
        <div className="flex justify-center items-center h-screen w-full bg-background transition-colors">
            <ScrollArea className="max-w-lg w-full mx-4 p-6 bg-card border rounded-md shadow-md space-y-4">
                <h1 className="text-2xl font-semibold text-primary text-center">
                    Welcome to adVentures, Drivers!
                </h1>
                <div className="flex flex-col space-y-4 text-center">
                    ...
                    <Button
                        ...
                        onClick={() => { window.location.href = ('/driver/earn') }}
                    >
                        Start the Process
                    </Button>
                </div>

...
const AdminLogin: React.FC = () => {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        console.log(values) // Replace this with the admin login logic
    }
        ...
        <div className="flex h-screen w-screen">
            ...
            <div className="hidden md:flex w-1/2 relative bg-slate-800">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center flex-col gap-10">
                    <h1 className="text-4xl font-bold text-white text-center">
                        Welcome to <span className="font-extrabold text-red-700">Ad Ventures</span> <br /> Admin Login
                    </h1>
                </div>
            </div>
            ...
            <div className="md:w-1/2 flex flex-col h-1/2 my-auto max-md:w-full">
                ...
                <p className="text-center text-gray-600 mt-4">
                    Not an admin? <a href="/auth/book-ad/signup" className="text-blue-600">Sign Up to book Ad</a>
                </p>
            </div>
        </div>
    )
